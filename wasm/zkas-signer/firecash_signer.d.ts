 ...
 */
export function verify_and_sign_payment_with_memo(seed_hex: string, network: string, to_address: string, amount_sompi: bigint, max_fee_sompi: bigint, memo: string, bundle_hex: string, disclosure_json: string, alphas_json: string): string;
/**
...
export interface InitOutput {
  ...
  readonly verify_and_sign_payment_with_memo: (a: number, b: number, c: number, d: number, e: number, f: number, g: bigint, h: bigint, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => [number, number, number, number];
