...
interface KNSTransferSuccessProps {
  transactionIds?: string[] | undefined;
}

export default function KNSTransferSuccess({
  transactionIds,
}: KNSTransferSuccessProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      <Header title="Transferred" showPrevious={false} showClose={false} />
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col gap-2 text-center">
            ...
            <span className="px-10 text-sm text-gray-400">
              Your domain has been successfully transferred.
            </span>
          </div>
