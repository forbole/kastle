      ...
      <div className="flex h-full flex-col justify-stretch gap-6 p-4 pb-6 text-white">
        ...
        <div className="flex flex-grow flex-col items-stretch gap-4">
          ...
          <button
            ...
            type="button"
            className="mt-auto inline-flex items-center justify-center gap-x-2 rounded-full border border-transparent bg-icy-blue-400 py-5 text-base text-white hover:bg-zinc-700 disabled:bg-daintree-800 disabled:text-[#4B5563]"
          >
            Confirm
          </button>
        </div>
