          ...
          <div className="bg-white/1 flex flex-col gap-8 rounded-lg border border-daintree-700 p-6">
            ...
            <div className="flex items-center gap-1 text-base">
              <i
                ...
                data-tooltip-content={`Fee Charged Every 10 transactions ${(10 * mintAmount).toLocaleString()} ${ticker}. If you stop before reaching 10, the remaining fee will be charged at that time.`}
              ></i>
              <Tooltip
                id="info-tooltip"
                style={{
