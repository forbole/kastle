...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="no-scrollbar relative flex w-full flex-1 flex-col overflow-y-scroll px-3">
        {/* Warning popup */}
        {showWarning && !dismissWarning && (
          ...
          >
            ...
            <span className="text-sm text-daintree-400">
              Please back up your recovery phrase 📜. It’s the 🗝️ key to
              accessing your Kastle if you lose your password or reinstall your
        ...
        <div className="flex w-full items-center justify-between gap-4 py-4">
          <div className="relative flex cursor-pointer rounded-lg font-semibold">
            ...
            >
              <Copy size={16} className="mx-2 text-white" />
              <ChevronDown
                size={8}
                absoluteStrokeWidth
                strokeWidth={1.5}
                className="mr-2 text-daintree-400"
              />
            </div>
          ...
          <div className="flex">
            <button
              className="flex size-[46px] items-center justify-center text-white"
          ...
          <div className="flex w-full justify-center gap-5 text-sm text-daintree-400">
            ...
            >
              ...
              >
                <ArrowUp
                  size={20}
                  className={isConnected ? "text-white" : "text-daintree-600"}
                />
              </div>
