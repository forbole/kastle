...
export default function AssetSelect() {
  ...
  const filteredErc20Assets = assets.filter((asset) =>
    hasSearchQuery ? true : asset.symbol.startsWith(searchQuery),
  );
  ...
  return (
    <div className="h-full w-full p-4">
      ...
      <div className="relative flex items-center pb-4">
        ...
        <input
          type="text"
          className="block w-full rounded-lg border-daintree-700 bg-[#051D26] pe-4 ps-10 text-sm text-white placeholder-daintree-400 focus:border-daintree-700 focus:ring-daintree-700 disabled:pointer-events-none disabled:opacity-50"
