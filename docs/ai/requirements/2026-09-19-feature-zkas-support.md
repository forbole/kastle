...
- The wallet switcher lists Kaspa wallets on Kaspa networks and eligible recovery-phrase and imported-seed wallets on ZKas Mainnet. Ledger and passphrase-backed accounts are unavailable on ZKas.
