...
export function isZKasActive(settings: Settings | null | undefined, experimentalEnabled: boolean | null): boolean {
  ...
  return settings?.preview === true &&
    experimentalEnabled !== false &&
    settings.activeChain === "zkas" &&
    settings.networkId === NetworkType.Mainnet;
}

export function getSelectedWalletNetwork(settings: Settings, experimentalEnabled: boolean | null): WalletNetwork {
  return isZKasActive(settings, experimentalEnabled) ? ZKAS_MAINNET : settings.networkId;
}

export function getVisibleWalletNetworks(settings: Settings, experimentalEnabled: boolean | null): WalletNetwork[] {
...
export function selectWalletNetwork(settings: Settings, network: WalletNetwork, experimentalEnabled: boolean | null): Settings {
