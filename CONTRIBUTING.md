...
[Kastle Code of Conduct](https://github.com/forbole/kastle/blob/master/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report unacceptable behavior
to <dev@forbole.com>.

## I Have a Question

Before you ask a question, it is best to search for existing [Issues](https://github.com/forbole/kastle/issues) that
...
- Open an [Issue](https://github.com/forbole/kastle/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  the [bug tracker](https://github.com/forbole/kastle/issues?q=label%3Abug).
...
> tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <security@forbole.com>.

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/forbole/kastle/issues/new). (Since we can't be sure at this point whether it is a
...
This section guides you through submitting an enhancement suggestion for Kastle, **including completely new features and
...
- Make sure that you are using the latest version.
- Perform a [search](https://github.com/forbole/kastle/issues) to see if the enhancement has already been suggested. If
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/forbole/kastle/issues).
...
- **Explain why this enhancement would be useful** to most Kastle users. You may also want to point out the other
...
Follow [conventional commit](https://www.conventionalcommits.org/en/v1.0.0/) standard.
